		...
		snippets: [
			{
				...
				gen: function () {
					return dedent`
						##### Sample Agent List
						| Cell Name | Real Name | Profession |
						|:------------------|:-----:|:-----------------:|
						| K-CELL                 |   Jacqueline Maguire,   | Executive Assistant Director of the Science and Technology Branch, FBI                |
						| K-CELL               | Gordon Ramsay     | Chef                |
						| A-CELL               | Jennifer Anniston     | Actress                |
						\n`;
				}
			},
			{
				...
				gen: function () {
					return dedent`
						{{wide
						##### FIELD OPERATIONS: UNOFFICIAL GUIDANCE
						| Situation | What You Say (Official) | What You Do (Actual) | What Happens Next |
						|:---------|:-------------------------|:---------------------|:------------------|
						| Local cops show up | “We’re with the Federal response team.” | Flash a badge. Walk fast. Don’t blink. | They let you through, then ask dispatch who you are. |
						| Civilian asks questions | “Routine maintenance.” | Redirect attention to a safer lie. | They post about it online anyway. |
						| You find a strange symbol | “Photograph and document.” | Touch it. You know you shouldn’t. | Later, your report includes the word “avoidable.” |
						| You need a warrant | “We’ll follow procedure.” | Call the friend who owes you a favor. | Paperwork appears. It’s wrong. It always is. |
						| Someone says “It’s probably nothing” | “Stay vigilant.” | Update your will mentally. | It was not nothing. |
						| The op goes sideways | “We’re aborting.” | Run. Burn it. Deny it. | Congratulations, you’re now “desk support.” |
						}}\n`;
				}
			},
			{
